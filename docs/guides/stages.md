...
5. **Models**:
    ...
    * If you decide to use fact-based modeling, you can use the [model diagrams guide](../models/model-diagrams.md).
6. **UI**:
...
3. **Models**:
    ...
    * For example, if you adopt LinkML, you can use the [LinkML models-as-code guide](../models/linkml-code.md).
