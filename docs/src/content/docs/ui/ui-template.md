---
title: "Creating UI designs with draw.io"
---
...
- [Caseum-Wireframe.xml](/ui/Caseum-Wireframe.xml): a [draw.io](https://www.diagrams.net/) custom shape library with simple mockup elements using the Caseum colors. [User guide](https://desk.draw.io/support/solutions/articles/16000067790).
- [wireframe.drawio](/ui/wireframe.drawio): a draw.io stencil containing the elements in the custom shape library.

Visually, Caseum UI designs look like this:

![picture of the wireframe.drawio file above](/ui/wireframe.drawio.png)
