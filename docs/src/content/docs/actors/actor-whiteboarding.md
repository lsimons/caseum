...
![Processed photo of a whiteboard containing actors](/actors/actor-whiteboarding-example.jpg)
...
<img src="/caseum/actors/actor-whiteboarding-lines.png" width="100" align="right" style="margin-left: 10px" alt="A drawing of a circle on top of a flat rectangle representing an actor">
