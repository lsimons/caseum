---
title: "Drawing architecture diagrams with draw.io"
---
...
![Screenshot of draw.io running within github.dev editing a Caseum diagram](/guides/drawio-example.png)
...
| -------------- | ---------------------------------------------- |
| **Components** | [C4 Draw.io Library](/components/c4-template/) |
| **Actors**     | _use markdown_                                 |
| **Stories**    | _use markdown_                                 |
| **Events**     | [ES Draw.io Library](/events/event-template/)  |
| **UI**         | [Wireframes Draw.io Library](/ui/ui-template/) |
| **Models**     | [Model diagrams](/models/model-diagrams/)      |
