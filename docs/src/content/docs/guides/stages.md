...
![Several screenshots of architecture views at different stages](/guides/stages-example.png)
...
This guide is for starting from scratch. Most architecture work is not for completely new software systems but starting from scratch is the easiest way to learn Caseum. See the [guide on as-is and to-be](/guides/as-is-to-be/) for working on existing systems.
...
You can use the general [guide on whiteboarding](/guides/whiteboarding/).
...
1. **Actors**:
   ...
   - You can use the [guide on whiteboarding actors](/actors/actor-whiteboarding/).
2. **Stories**:
   ...
   - You can use the [guide on whiteboarding stories](/stories/story-whiteboarding/).
3. **UI**:
   ...
   - You can use the [guide on whiteboarding wireframes](/ui/ui-whiteboarding/).
4. **Events**:
   ...
   - You can use the [guide on event storming](/events/event-storming/).
5. **Components**:
   ...
   - You can use the [guide on whiteboarding C4](/components/c4-whiteboarding/).
6. **Models**:
   ...
   - You can use the [guide on whiteboarding facts](/models/fact-whiteboarding/).
...
- If it seems like your group disagrees about a particular detail, slow down a bit. First figure out what the disagreement is. Write down a question. Then have a brief discussion. If consent on an answer is not quickly found, capture it as a topic to detail later. If you use [ADRs or RFDs](/guides/records/), this may be a good topic for such a document.
...
4. **Components**:
   ...
   - You can use the [C4 template](/components/c4-template/).
5. **Models**:
   ...
   - Object-oriented or table-oriented modeling is more common than the fact-based modeling that Caseum recommends. You can [read why fact-based modeling is great](/models/fact-modeling/) and decide to try it, or, you can use a modeling approach you already know.
   - If you decide to use fact-based modeling, you can use the [model diagrams guide](/models/model-diagrams/).
6. **UI**:
   ...
   - If you do not have such digital designs, you can use the [UI template](/ui/ui-template/) to make digital wireframes.
...
See the [guide on keeping records](/guides/records/).
...
However, for larger systems the non-functional requirements may become relatively more and more challenging to meet. Such needs are often not easy to visualize either. Instead, consider keeping more detailed [records](/guides/records/) such as Architecture Decision Records (ADRs) or Requests For Discussion (RFDs) that explain how the non-functional requirements are being met.
...
1. **Stories**:
   ...
   - You can use the [Gherkin coding guide](/stories/gherkin-code/).
2. **Components**:
   - C4 has a great textual format in Structurizr that is worth using if you have a lot of components.
   - You can use the [C4 coding guide](/components/c4-code/).
3. **Models**:
   ...
   - For example, if you adopt LinkML, you can use the [LinkML models-as-code guide](/models/linkml-code/).
...
4. **Events**:
   ...
   - Otherwise, you can use the [AsyncAPI coding guide](/events/asyncapi-code/).
5. **Actors**:
...
If you have many developer teams you may consider a platform team that focuses on providing a platform layer to the other developer teams. See the [guide on platforms](/guides/platforms/) for how to use Caseum in that situation.
