...
![Processed photo of a whiteboard containing architecture diagrams](/guides/whiteboarding-example.jpg)
...
Reserve time at the end of a whiteboarding session to immediately capture all the content you produced in a permanent form and [record it](/guides/records/). Taking photos with your cell phone and uploading them works well.
...
- Have enough decent quality sticky notes. The adhesive on old or cheap sticky notes gets worse and then the notes may come down off the board. Have multiple colors (for [event storming](/events/event-storming/): orange, purple, blue, green).
...
- study the [Caseum color scheme](/design/colors/colors/) and try to make drawings on the whiteboard in the same or a similar color scheme
...
To draw a good design together as a group, all of these contributions are needed. It is useful to get good at each style of contribution, and to know when which contribution is needed. It can be a good exercise for people in a team to deliberately take one of these roles, even if they would normally take a different one. You can also rotate between these roles in a way similar to [pair programming](https://www.agilealliance.org/glossary/pair-programming/) or [mob programming](https://www.agilealliance.org/glossary/mob-programming/).
...
On a fully remote team you can also skip directly to [the next stage](/guides/stages/) and work with digital files.
...
Such brownpaper sessions can sometimes work well, especially for work closer to requirements than to design, like when using [event storming](/events/event-storming/).
...
This last point is why brownpaper sessions don't work as well for [ui design](/ui/ui-whiteboarding/).
