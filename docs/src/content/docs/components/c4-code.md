---
title: "Modeling components in code using C4 and Structurizr"
---

**Use [Structurizr](https://structurizr.org/) to model the components of your system in code.**

![Example of using Structurizr to make a C4 container diagram](/components/c4-code-structurizr-example.png)
...
Note that while the C4 website recommends using models as code, Caseum recommends [using a whiteboard](/components/c4-whiteboarding/) initially and for as long as possible, and to also consider [digital diagrams](/components/c4-template/) before making models using code.
