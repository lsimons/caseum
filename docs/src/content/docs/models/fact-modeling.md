...
1. [Whiteboard the facts](/models/fact-whiteboarding/) together with the domain experts.
2. [Draw a tidy diagram](/models/model-diagrams/) if you need to communicate or review the model.
3. [Land the facts in code with LinkML](/models/linkml-code/) if you need generated JSON Schema, SQL, or docs.
