---
title: "Describing Models as Code using LinkML"
---
...
Once the facts are agreed on the whiteboard ([stage 1](/models/fact-whiteboarding/)) and drawn ([stage 2](/models/model-diagrams/)), stage 3 lands them in code. Keeping one schema file and generating the rest — API schema, database schema, docs — stops those artifacts from drifting out of sync.
