...
<img src="/caseum/events/event-storming-example.jpg" width="400" align="right" style="margin-left: 10px" alt="Processed photo of a whiteboard containing events">
...
Contrast this with the Caseum [stages guide](/guides/stages/) which suggests defining some actors, some stories, and some UI first, before diving into domain events. This approach could be more appropriate for designing new systems from scratch. Try both approaches and see which works best for you!
...
So when switching to digital designs, Caseum instead has an [event template](/events/event-template/) for capturing events.
